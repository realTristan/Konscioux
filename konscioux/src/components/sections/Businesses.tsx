export default function Businesses(): JSX.Element {
  return (
    <div
      className="stripes-white-45 relative flex h-full w-screen flex-wrap items-center justify-center p-10"
      id="businesses"
    >
      <Business
        name="Konscioux"
...
function Business(props: BusinessProps): JSX.Element {
  return (
    <div className="flex h-auto w-auto flex-col items-start justify-start gap-2 bg-slate-50 p-4 text-center hover:bg-slate-100">
